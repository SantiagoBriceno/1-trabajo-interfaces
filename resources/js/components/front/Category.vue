<script setup>
  ...
  import category3 from "../assets/futbol/images/champions.png"
...
<template>
  <section id="category" class="flex flex-col items-center py-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 place-items-center gap-20">
      <div v-for="category of categories" :key="category.title" class="text-white grid place-items-center text-center p-8 rounded-md max-h-fit bg-gradient-to-b from-primary-200/20 to-primary-200/10" :style="{backgroundColor: colors ? colors.color2 : '',}">
