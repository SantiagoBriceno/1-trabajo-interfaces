...
<template>
  <footer :style="{color: colors ? colors.color4 : '',}">
    <div class="grid grid-cols-1 ml-11 md:grid-cols-2 gap-10 md:gap-28">
      <div>
        <div class="flex gap-2 mb-5">
          <h1 class="text-white font-bold text-2xl" >Hallow<span class="text-secondary" :style="{color: colors ? colors.color2 : '',}">ee</span>d</h1>
        ...
        <p class="text-white leading-loose tracking-wide w-full md:w-[80%]">Made by SSC Programming Group</p>
