  ...
  <nav ref="navbar" class="fixed top-0 left-0 w-full bg-primary-200 z-20 transition duration-200" :style="{backgroundColor: colors ? colors.color1 : '',}">
    <div class="container flex items-center justify-between h-20">
      ...
      <div class="flex lg:hidden items-center gap-2">
        <button class="relative z-30 px-4 py-2 -mt-1.5 text-sm rounded-full text-white font-medium tracking-wider uppercase bg-secondary w-full lg:w-auto" :style="{background: colors ? colors.color2 : '',}">Donate</button>
